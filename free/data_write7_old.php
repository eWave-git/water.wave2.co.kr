...
if ($bd_type != 1) {
	...
	$sql = "INSERT INTO water.raw_data (`create_at`,`address`,`board_type`,`board_number`,`data1`,`data2`,`data3`,`data4`,`data5`,`data6`,`data7`)
    		VALUES ('{$create_at}', $address, $bd_type, $bd_number, $d1, $d2, $d3, $d4, $d5, $d6, $d7)";

	$result = mysqli_query($conn, $sql);
}

$control_sql = "select * from water.control_data where address = $address and board_type = $bd_type and board_number = $bd_number order by create_at desc limit 1 ";
