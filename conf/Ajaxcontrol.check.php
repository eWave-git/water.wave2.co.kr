...
if ($_REQUEST['relay'] == 'relay1') {
    $sql = "select * from ewavetest.control_data where type='relay2' order by create_at desc limit 1";
    ...
    $sql = "select * from ewavetest.control_data where type='relay1' order by create_at desc limit 1";
    $result = mysqli_query($conn, $sql);
    $row = mysqli_fetch_array($result);
