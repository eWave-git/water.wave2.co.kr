...
(MAX(IF(board_number=3, data1, NULL)) - MIN(IF(board_number=3, data1, NULL)) ) as daily_1building
FROM upa.raw_data
WHERE created_at >= \"2023-11-11\" and created_at < current_date() and address = '2300' and board_type = 6
group by DF
ORDER BY idx asc;
"; 
